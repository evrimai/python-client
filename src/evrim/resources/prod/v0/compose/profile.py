...
from .....types.prod.v0.compose import profile_create_snapshot_params
from .....types.prod.v0.compose.profile_create_snapshot_response import ProfileCreateSnapshotResponse
...
class ProfileResource(SyncAPIResource):
    ...
    def create_snapshot(
        ...
        *,
        ...
        created_field_ids: Iterable[int],
        specification: str,
        template_id: int,
        ...
        """
        return self._post(
            "/prod/v0/compose/profile/snapshot/",
            body=maybe_transform(
                ...
                profile_create_snapshot_params.ProfileCreateSnapshotParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ProfileCreateSnapshotResponse,
        )
